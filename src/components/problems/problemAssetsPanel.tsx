...
function AssetsUploadTab({
    problemId,
    selectedAsset,
}: {
    problemId: string;
    selectedAsset?: ProblemDetail["assets"][number];
}) {
    return (
        <div className="space-y-6">
            <Card>
                ...
                <div className="grid gap-6 p-4 lg:grid-cols-[1.2fr_0.8fr]">
                    <div className="rounded-none border border-dashed border-slate-300 bg-slate-50 p-5">
                        ...
                        <p className="mt-3 text-sm leading-6 text-slate-700">
                            PNG / JPG / SVG
                            を追加できます。ドラッグ&ドロップまたはファイル選択を想定した領域です。
                        </p>
...
export function ProblemAssetsPanel({
    problemId,
    assets,
}: ProblemAssetsPanelProps) {
