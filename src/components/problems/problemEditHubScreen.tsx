...
export function ProblemEditHubScreen({
    problemId,
    screen,
}: ProblemEditHubScreenProps) {
    const sections = getProblemEditSections(problemId).filter(
