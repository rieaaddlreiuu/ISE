    ...
    return (
        <header className="fixed inset-x-0 top-0 z-50 border-b border-slate-200 bg-white/90 backdrop-blur">
            <div className="mx-auto flex h-16 w-full max-w-6xl items-center gap-4 px-4 sm:px-6">
                ...
                <nav aria-label="Global" className="flex min-w-0 flex-1 items-center gap-2 overflow-x-auto">
                    ...
                    <div className="hidden h-5 w-px shrink-0 bg-slate-200 sm:block" aria-hidden="true" />
