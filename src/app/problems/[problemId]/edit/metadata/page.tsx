...
type ProblemMetadataEditPageProps =
    PageProps<"/problems/[problemId]/edit/metadata">;

export async function generateMetadata(
    props: ProblemMetadataEditPageProps,
): Promise<Metadata> {
...
export default async function ProblemMetadataEditPage(
    props: ProblemMetadataEditPageProps,
) {
    const { problemId } = await props.params;
